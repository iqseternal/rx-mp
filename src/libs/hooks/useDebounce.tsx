 ...
 * @returns
 */
export function useDebounceHook<T extends (...args: any[]) => void>(this: any, callback: T, options: DebounceOptions) {
 ...
 *
 */
export function useThrottleHook<T extends (...args: unknown[]) => void>(this: any, callback: T, options: ThrottleOptions) {
  const { wait } = options;
