import type { Axios, AxiosResponse } from '@suey/pkg-utils';
import type { ComponentType } from 'react';
import type { RXApiBasicResponse, RXApiFailResponse, RXApiSuccessResponse, RXApiPromiseLike } from './api';
import type { ApiPromiseLikeTypeBuilder } from '@suey/pkg-utils';
...
export type BusInvokerEntries = {
   ...
   * api-err 分发器
   */
  'rx-api-err-distributor': (response: AxiosResponse<RXApiSuccessResponse, RXApiFailResponse>) => Promise<AxiosResponse<RXApiBasicResponse>>;

  'rx-api-err:unauthorized-resource': (response: AxiosResponse<RXApiSuccessResponse, RXApiFailResponse>) => Promise<AxiosResponse<RXApiBasicResponse>>;
  'rx-api-err:unauthorized-credential': (response: AxiosResponse<RXApiSuccessResponse, RXApiFailResponse>) => Promise<AxiosResponse<RXApiBasicResponse>>;
